...
public enum RoleSort {
    ...
    GUARD(WinType.VILLAGE, RoleType.VILLAGER, Lang.GUARD.getId()),
    LG_INFECTE(WinType.VILLAGE, RoleType.LOUP_GAROU, Lang.LG_INFECTE.getId()),
    CUPIDON(WinType.VILLAGE, RoleType.NEUTRAL, Lang.CUPIDON.getId()),
